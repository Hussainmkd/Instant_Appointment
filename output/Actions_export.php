...
$layout->blocks["top"][] = "export";$page_layouts["Actions_export"] = $layout;
...
$xt->display("Actions_export.htm");

function ExportToWord()
{
	global $cCharset;
	header("Content-Type: application/vnd.ms-word");
	header("Content-Disposition: attachment;Filename=Actions.doc");
...
function ExportToXML()
{
	...
	header("Content-Disposition: attachment;Filename=Actions.xml");
	...
	while((!$nPageSize || $i<$nPageSize) && $row)
	{
		...
		$values = array();
			...
			$values["Action"] = GetData($row,"Action","");
...
// write data rows
	...
	while((!$nPageSize || $iNumberOfRows<$nPageSize) && $row)
	{
		...
		$values = array();
			...
			$format="";
			$values["Action"] = GetData($row,"Action",$format);
...
// write header
	...
	{
		echo '<td style="width: 100" x:str>'.PrepareForExcel(GetFieldLabel("dbo_Actions","Code")).'</td>';	
		echo '<td style="width: 100" x:str>'.PrepareForExcel(GetFieldLabel("dbo_Actions","Action")).'</td>';	
	}
	else
	{
		echo "<td>".GetFieldLabel("dbo_Actions","Code")."</td>";
		echo "<td>".GetFieldLabel("dbo_Actions","Action")."</td>";
	}
	echo "</tr>";
		$totals["Code"]=0;
