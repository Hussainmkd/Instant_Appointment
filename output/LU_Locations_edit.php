...
include("include/LU_Locations_variables.php");
...
$layout->blocks["top"][] = "details";$page_layouts["LU_Locations_edit"] = $layout;
...
$templatefile = ($inlineedit == EDIT_INLINE) ? "LU_Locations_inline_edit.htm" : "LU_Locations_edit.htm";
...
if ($IsSaved && no_output_done() && $inlineedit == EDIT_SIMPLE)
{
	...
	// redirect
	header("Location: LU_Locations_".$pageObject->getPageType().".php?".$keyGetQ);
...
/////////////////////////////////////////////////////////////
$query = $queryData_LU_Locations->Copy();
...
if(!$data)
{
	...
	{
		header("Location: LU_Locations_list.php?a=return");
		exit();
	}
	else
		$data = array();
...
if($pageObject->isShowDetailTables && $inlineedit!=EDIT_INLINE && !isMobile())
{
	...
	for($d=0;$d<count($dpParams['ids']);$d++)
	{
		...
		$options['masterTable'] = "dbo.LU_Locations";
		$options['firstTime'] = 1;
...
$xt->assign("viewlink_attrs","id=\"viewButton".$id."\" name=\"viewButton".$id."\" onclick=\"window.location.href='LU_Locations_view.php?".$viewlink."'\"");
