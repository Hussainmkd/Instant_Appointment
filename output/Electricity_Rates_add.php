...
$layout->blocks["top"][] = "details";$page_layouts["Electricity_Rates_add"] = $layout;
...
if($inlineadd == ADD_INLINE)
	$templatefile = "Electricity_Rates_inline_add.htm";
else
	$templatefile = "Electricity_Rates_add.htm";
...
if(@$_POST["a"]=="added")
{
	...
	$avalues=array();
	$blobfields=array();
//	processing PerUnit Price - start
	...
	if($inlineAddOption)
	{
		...
		if(!($value===false))
		{
				...
				$value=md5($value);
			$avalues["PerUnit Price"]=$value;
		}
		}
//	processibng PerUnit Price - end
...
if (no_output_done() && $inlineadd==ADD_SIMPLE && $IsSaved)
{
	...
	// redirect
	header("Location: Electricity_Rates_".$pageObject->getPageType().".php");
...
if(array_key_exists("copyid1",$_REQUEST) || array_key_exists("editid1",$_REQUEST))
{
	...
	{
		$copykeys["Units"]=postvalue("copyid1");
	}
	else
	{
		$copykeys["Units"]=postvalue("editid1");
	}
...
if($readavalues)
{
	$defvalues["PerUnit Price"]=@$avalues["PerUnit Price"];
}
