...
$layout->blocks["top"][] = "search";$page_layouts["User_Roles_search"] = $layout;
...
$mode=SEARCH_SIMPLE;
$templatefile = "User_Roles_search.htm";

// for ajax query, used when page buffers new control
if(postvalue("mode")=="inlineLoadCtrl"){
	$mode = SEARCH_LOAD_CONTROL;
	$templatefile = "User_Roles_inline_search.htm";
}	
...
$params['xt'] = &$xt;
$params['shortTableName'] = 'User_Roles';
