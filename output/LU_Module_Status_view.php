...
$layout->blocks["top"][] = "details";$page_layouts["LU_Module_Status_view"] = $layout;
...
$xt->assign("editlink_attrs","id=\"editLink".$id."\" name=\"editLink".$id."\" onclick=\"window.location.href='LU_Module_Status_edit.php?".$editlink."'\"");
...
$templatefile = "LU_Module_Status_view.htm";
