...
$layout->blocks["top"][] = "pdf";$page_layouts["Anomalies_print"] = $layout;
...
//	include proper masterprint.php code
	include("include/Actions_masterprint.php");
	$masterkeys[]=@$_SESSION[$strTableName."_masterkey1"];
	$params=array("detailtable"=>"dbo.Anomalies","keys"=>$masterkeys);
	$master=array();
	$master["func"]="DisplayMasterTableInfo_Actions";
...
{
//	include proper masterprint.php code
	include("include/LU_Anomaly_Type_masterprint.php");
	$masterkeys[]=@$_SESSION[$strTableName."_masterkey1"];
	$params=array("detailtable"=>"dbo.Anomalies","keys"=>$masterkeys);
	$master=array();
	$master["func"]="DisplayMasterTableInfo_LU_Anomaly_Type";
	$master["params"]=$params;
	$xt->assignbyref("showmasterfile",$master);
	$xt->assign("mastertable_block",true);
}
...
$xt->assign("Anomaly_Description_fieldheadercolumn",true);
$xt->assign("Anomaly_Description_fieldheader",true);
$xt->assign("Anomaly_Description_fieldcolumn",true);
$xt->assign("Anomaly_Description_fieldfootercolumn",true);
$xt->assign("Anomaly_Type_fieldheadercolumn",true);
$xt->assign("Anomaly_Type_fieldheader",true);
$xt->assign("Anomaly_Type_fieldcolumn",true);
$xt->assign("Anomaly_Type_fieldfootercolumn",true);
...
$xt->assign("Action_Taken_fieldheadercolumn",true);
$xt->assign("Action_Taken_fieldheader",true);
$xt->assign("Action_Taken_fieldcolumn",true);
$xt->assign("Action_Taken_fieldfootercolumn",true);
...
$templatefile = "Anomalies_print.htm";
