...
$layout->blocks["top"][] = "details";$page_layouts["LU_Locations_add"] = $layout;
...
if($inlineadd == ADD_INLINE)
	$templatefile = "LU_Locations_inline_add.htm";
else
	$templatefile = "LU_Locations_add.htm";
...
if (no_output_done() && $inlineadd==ADD_SIMPLE && $IsSaved)
{
	...
	// redirect
	header("Location: LU_Locations_".$pageObject->getPageType().".php");
