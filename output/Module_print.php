...
$layout->blocks["top"][] = "pdf";$page_layouts["Module_print"] = $layout;
...
$fieldsArr[] = $arr;
$arr = array();
$arr['fName'] = "Module Type";
$arr['viewFormat'] = ViewFormat("Module Type", $strTableName);
$fieldsArr[] = $arr;
$arr = array();
$arr['fName'] = "Module Status";
$arr['viewFormat'] = ViewFormat("Module Status", $strTableName);
$fieldsArr[] = $arr;
$arr = array();
$arr['fName'] = "Module Condition";
$arr['viewFormat'] = ViewFormat("Module Condition", $strTableName);
$fieldsArr[] = $arr;
$arr = array();
$arr['fName'] = "Serial Num";
$arr['viewFormat'] = ViewFormat("Serial Num", $strTableName);
$fieldsArr[] = $arr;
$arr = array();
$arr['fName'] = "Entry Date";
$arr['viewFormat'] = ViewFormat("Entry Date", $strTableName);
$fieldsArr[] = $arr;
...
//	include proper masterprint.php code
	include("include/LU_Module_Condition_masterprint.php");
	$masterkeys[]=@$_SESSION[$strTableName."_masterkey1"];
	$params=array("detailtable"=>"dbo.Module","keys"=>$masterkeys);
	$master=array();
	$master["func"]="DisplayMasterTableInfo_LU_Module_Condition";
...
{
//	include proper masterprint.php code
	include("include/LU_Module_Status_masterprint.php");
	$masterkeys[]=@$_SESSION[$strTableName."_masterkey1"];
	$params=array("detailtable"=>"dbo.Module","keys"=>$masterkeys);
	$master=array();
	$master["func"]="DisplayMasterTableInfo_LU_Module_Status";
	$master["params"]=$params;
	$xt->assignbyref("showmasterfile",$master);
	$xt->assign("mastertable_block",true);
}
...
{
//	include proper masterprint.php code
	include("include/LU_Module_Type_masterprint.php");
	$masterkeys[]=@$_SESSION[$strTableName."_masterkey1"];
	$params=array("detailtable"=>"dbo.Module","keys"=>$masterkeys);
	$master=array();
	$master["func"]="DisplayMasterTableInfo_LU_Module_Type";
	$master["params"]=$params;
	$xt->assignbyref("showmasterfile",$master);
	$xt->assign("mastertable_block",true);
}
...
$xt->assign("Module_Type_fieldheadercolumn",true);
$xt->assign("Module_Type_fieldheader",true);
$xt->assign("Module_Type_fieldcolumn",true);
$xt->assign("Module_Type_fieldfootercolumn",true);
$xt->assign("Module_Status_fieldheadercolumn",true);
$xt->assign("Module_Status_fieldheader",true);
$xt->assign("Module_Status_fieldcolumn",true);
$xt->assign("Module_Status_fieldfootercolumn",true);
$xt->assign("Module_Condition_fieldheadercolumn",true);
$xt->assign("Module_Condition_fieldheader",true);
$xt->assign("Module_Condition_fieldcolumn",true);
$xt->assign("Module_Condition_fieldfootercolumn",true);
$xt->assign("Serial_Num_fieldheadercolumn",true);
$xt->assign("Serial_Num_fieldheader",true);
$xt->assign("Serial_Num_fieldcolumn",true);
$xt->assign("Serial_Num_fieldfootercolumn",true);
$xt->assign("Entry_Date_fieldheadercolumn",true);
$xt->assign("Entry_Date_fieldheader",true);
$xt->assign("Entry_Date_fieldcolumn",true);
$xt->assign("Entry_Date_fieldfootercolumn",true);
