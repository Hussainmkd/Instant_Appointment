...
$layout->blocks["top"][] = "details";$page_layouts["LU_Customer_Type_add"] = $layout;
...
if($inlineadd == ADD_INLINE)
	$templatefile = "LU_Customer_Type_inline_add.htm";
else
	$templatefile = "LU_Customer_Type_add.htm";
...
if (no_output_done() && $inlineadd==ADD_SIMPLE && $IsSaved)
{
	...
	// redirect
	header("Location: LU_Customer_Type_".$pageObject->getPageType().".php");
