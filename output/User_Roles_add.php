...
$layout->blocks["top"][] = "details";$page_layouts["User_Roles_add"] = $layout;
...
if($inlineadd == ADD_INLINE)
	$templatefile = "User_Roles_inline_add.htm";
else
	$templatefile = "User_Roles_add.htm";
...
if (no_output_done() && $inlineadd==ADD_SIMPLE && $IsSaved)
{
	...
	// redirect
	header("Location: User_Roles_".$pageObject->getPageType().".php");
