...
$layout->blocks["top"][] = "pdf";$page_layouts["Customer_Module_Assignment_print"] = $layout;
...
//	include proper masterprint.php code
	include("include/Customers_masterprint.php");
	$masterkeys[]=@$_SESSION[$strTableName."_masterkey1"];
	$params=array("detailtable"=>"dbo.Customer Module Assignment","keys"=>$masterkeys);
	$master=array();
	$master["func"]="DisplayMasterTableInfo_Customers";
...
$templatefile = "Customer_Module_Assignment_print.htm";
