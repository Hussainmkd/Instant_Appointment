...
$layout->blocks["top"][] = "details";$page_layouts["System_Users_view"] = $layout;
...
/*$jsKeysObj = 'window.recKeysObj = {';
	$jsKeysObj .= "'".jsreplace("UserID")."': '".(jsreplace(@$data["UserID"]))."', ";
...
$xt->assign("editlink_attrs","id=\"editLink".$id."\" name=\"editLink".$id."\" onclick=\"window.location.href='System_Users_edit.php?".$editlink."'\"");
...
$templatefile = "System_Users_view.htm";
