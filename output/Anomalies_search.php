...
$layout->blocks["top"][] = "search";$page_layouts["Anomalies_search"] = $layout;
...
$mode=SEARCH_SIMPLE;
$templatefile = "Anomalies_search.htm";

// for ajax query, used when page buffers new control
if(postvalue("mode")=="inlineLoadCtrl"){
	$mode = SEARCH_LOAD_CONTROL;
	$templatefile = "Anomalies_inline_search.htm";
}	
...
$params['xt'] = &$xt;
$params['shortTableName'] = 'Anomalies';
...
if ($mode==SEARCH_SIMPLE)
{
	...
	if(GetLookupTable("Anomaly Description", $strTableName))
		$pageObject->settingsMap["globalSettings"]['shortTNames'][GetLookupTable("Anomaly Description", $strTableName)] = GetTableURL(GetLookupTable("Anomaly Description", $strTableName));
	
	$pageObject->fillFieldToolTips("Anomaly Description");	
		
	$srchFields = $pageObject->searchClauseObj->getSearchCtrlParams("Anomaly Description");
	$firstFieldParams = array();
	if (count($srchFields))
	{
		$firstFieldParams = $srchFields[0];
	...
	{
		$firstFieldParams['fName'] = "Anomaly Description";
		$firstFieldParams['eType'] = '';
		$firstFieldParams['value1'] = '';
		$firstFieldParams['opt'] = '';
		$firstFieldParams['value2'] = '';
	...
	$xt->assignbyref("Anomaly_Description_editcontrol", $ctrlBlockArr['searchcontrol']);					
	$xt->assign("Anomaly_Description_notbox", $ctrlBlockArr['notbox']);		
	// create second control, if need it		
	$xt->assignbyref("Anomaly_Description_editcontrol1", $ctrlBlockArr['searchcontrol1']);		
	// create search type select
	$xt->assign("searchtype_Anomaly_Description", $ctrlBlockArr['searchtype']);	
	$isFieldNeedSecCtrl = $searchControlBuilder->isNeedSecondCtrl("Anomaly Description");
	$ctrlInd = 0;
	if ($isFieldNeedSecCtrl) 
	{				
		$pageObject->controlsMap["search"]["searchBlocks"][] = array('fName'=>"Anomaly Description", 'recId'=>$id, 'ctrlsMap'=>array(0=>$ctrlInd, 1=>($ctrlInd+1)));
		$ctrlInd+=2;
	}
	else
	{	
		$pageObject->controlsMap["search"]["searchBlocks"][] = array('fName'=>"Anomaly Description", 'recId'=>$id, 'ctrlsMap'=>array(0=>$ctrlInd));			
		$ctrlInd++;
	}
	// search fields data
	
	if(GetLookupTable("Anomaly Type", $strTableName))
		$pageObject->settingsMap["globalSettings"]['shortTNames'][GetLookupTable("Anomaly Type", $strTableName)] = GetTableURL(GetLookupTable("Anomaly Type", $strTableName));
	
	$pageObject->fillFieldToolTips("Anomaly Type");	
		
	$srchFields = $pageObject->searchClauseObj->getSearchCtrlParams("Anomaly Type");
	$firstFieldParams = array();
	if (count($srchFields))
	{
		$firstFieldParams = $srchFields[0];
	...
	{
		$firstFieldParams['fName'] = "Anomaly Type";
		$firstFieldParams['eType'] = '';
		$firstFieldParams['value1'] = '';
		$firstFieldParams['opt'] = '';
		$firstFieldParams['value2'] = '';
	...
	$xt->assignbyref("Anomaly_Type_editcontrol", $ctrlBlockArr['searchcontrol']);					
	$xt->assign("Anomaly_Type_notbox", $ctrlBlockArr['notbox']);		
	// create second control, if need it		
	$xt->assignbyref("Anomaly_Type_editcontrol1", $ctrlBlockArr['searchcontrol1']);		
	// create search type select
	$xt->assign("searchtype_Anomaly_Type", $ctrlBlockArr['searchtype']);	
	$isFieldNeedSecCtrl = $searchControlBuilder->isNeedSecondCtrl("Anomaly Type");
	$ctrlInd = 0;
	if ($isFieldNeedSecCtrl) 
	{				
		$pageObject->controlsMap["search"]["searchBlocks"][] = array('fName'=>"Anomaly Type", 'recId'=>$id, 'ctrlsMap'=>array(0=>$ctrlInd, 1=>($ctrlInd+1)));
		$ctrlInd+=2;
	}
	else
	{	
		$pageObject->controlsMap["search"]["searchBlocks"][] = array('fName'=>"Anomaly Type", 'recId'=>$id, 'ctrlsMap'=>array(0=>$ctrlInd));			
		$ctrlInd++;
	}
	// search fields data
	...
	if(GetLookupTable("Action Taken", $strTableName))
		$pageObject->settingsMap["globalSettings"]['shortTNames'][GetLookupTable("Action Taken", $strTableName)] = GetTableURL(GetLookupTable("Action Taken", $strTableName));
	
	$pageObject->fillFieldToolTips("Action Taken");	
		
	$srchFields = $pageObject->searchClauseObj->getSearchCtrlParams("Action Taken");
	$firstFieldParams = array();
	if (count($srchFields))
	{
		$firstFieldParams = $srchFields[0];
	...
	{
		$firstFieldParams['fName'] = "Action Taken";
		$firstFieldParams['eType'] = '';
		$firstFieldParams['value1'] = '';
		$firstFieldParams['opt'] = '';
		$firstFieldParams['value2'] = '';
	...
	$isFieldNeedSecCtrl = $searchControlBuilder->isNeedSecondCtrl("Action Taken");
	$ctrlInd = 0;
	if ($isFieldNeedSecCtrl) 
	{				
		$pageObject->controlsMap["search"]["searchBlocks"][] = array('fName'=>"Action Taken", 'recId'=>$id, 'ctrlsMap'=>array(0=>$ctrlInd, 1=>($ctrlInd+1)));
		$ctrlInd+=2;
	}
	else
	{	
		$pageObject->controlsMap["search"]["searchBlocks"][] = array('fName'=>"Action Taken", 'recId'=>$id, 'ctrlsMap'=>array(0=>$ctrlInd));			
		$ctrlInd++;
	}
