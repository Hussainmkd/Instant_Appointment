...
$layout->blocks["top"][] = "details";$page_layouts["User_Roles_view"] = $layout;
...
//Role - 
	...
	$value="";
	$value = ProcessLargeText(GetData($data,"Role", ""),"","",MODE_VIEW);
...
$xt->assign("editlink_attrs","id=\"editLink".$id."\" name=\"editLink".$id."\" onclick=\"window.location.href='User_Roles_edit.php?".$editlink."'\"");
...
$templatefile = "User_Roles_view.htm";
