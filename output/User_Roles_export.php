...
$layout->blocks["top"][] = "export";$page_layouts["User_Roles_export"] = $layout;
...
$xt->display("User_Roles_export.htm");

function ExportToWord()
{
	global $cCharset;
	header("Content-Type: application/vnd.ms-word");
	header("Content-Disposition: attachment;Filename=User_Roles.doc");
...
function ExportToXML()
{
	...
	header("Content-Disposition: attachment;Filename=User_Roles.xml");
