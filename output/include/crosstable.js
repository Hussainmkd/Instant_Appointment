...
shref=window.location.href;pos=shref.indexOf("&axis_x",0);if(pos>=0)
shref=shref.substr(0,pos);$.get(shref,{axis_x:$("#select_group_x")[0].value,axis_y:$("#select_group_y")[0].value,field:$("#select_data")[0].value,group_func:grfunc_value,crosstable_refresh:true,rndVal:(new Date().getTime())},function(txt)
...
$("#id_total_summary").html(obj[2]);$("#group_func").html(obj[3]);});}
