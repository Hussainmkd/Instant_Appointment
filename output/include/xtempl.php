...
//	set page style
		...
		$this->assign("pagestylepath","pagestyles/".$layout->name.($this->getReadingOrder() == 'RTL' ? 'RTL' : '').".css");
		$this->assign("stylepath","styles/".$pageStyle."/style".($this->getReadingOrder() == 'RTL' ? 'RTL' : '').".css");
		$this->assign("stylepathIE","styles/".$pageStyle."/styleIE.css");
