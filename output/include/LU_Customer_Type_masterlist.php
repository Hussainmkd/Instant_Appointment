...
$layout->blocks["bare"][] = "mastergrid";$page_layouts["LU_Customer_Type_masterlist"] = $layout;


if($detailtable=="dbo.Customers")
{
		$where.= GetFullFieldName("Code")."=".make_db_value("Code",$keys[1-1]);
	$showKeys .= " ".GetFieldLabel("dbo_LU_Customer_Type","Code").": ".$keys[1-1];
...
//	Type - 
	...
	$xt->display("LU_Customer_Type_masterlist.htm");
	$strTableName=$oldTableName;
}
