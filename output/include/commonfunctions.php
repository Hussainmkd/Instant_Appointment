...
function checkTableName($shortTName, $type=false)
{
	...
	if ("Actions" == $shortTName && ($type===false || ($type!==false && $type == 0)))
	{
		return true;	
	}
	if ("Anomalies" == $shortTName && ($type===false || ($type!==false && $type == 0)))
	{
		return true;	
	}
	if ("Customer_Module_Assignment" == $shortTName && ($type===false || ($type!==false && $type == 0)))
	{
		return true;	
	}
	...
	if ("Electricity_Rates" == $shortTName && ($type===false || ($type!==false && $type == 0)))
	{
		return true;	
	}
	if ("LU_Anomaly_Type" == $shortTName && ($type===false || ($type!==false && $type == 0)))
	{
		return true;	
	}
	if ("LU_Customer_Type" == $shortTName && ($type===false || ($type!==false && $type == 0)))
	{
		return true;	
	}
	if ("LU_Locations" == $shortTName && ($type===false || ($type!==false && $type == 0)))
	{
		return true;	
	}
	if ("LU_Module_Condition" == $shortTName && ($type===false || ($type!==false && $type == 0)))
	{
		return true;	
	}
	if ("LU_Module_Status" == $shortTName && ($type===false || ($type!==false && $type == 0)))
	{
		return true;	
	}
	if ("LU_Module_Type" == $shortTName && ($type===false || ($type!==false && $type == 0)))
	{
		return true;	
	}
	if ("Module" == $shortTName && ($type===false || ($type!==false && $type == 0)))
	{
		return true;	
	}
	if ("Month_Billings" == $shortTName && ($type===false || ($type!==false && $type == 0)))
	{
		return true;	
	}
	...
	if ("User_Roles" == $shortTName && ($type===false || ($type!==false && $type == 0)))
	{
		return true;	
	}
	if ("System_Users" == $shortTName && ($type===false || ($type!==false && $type == 0)))
	{
		return true;	
	}
	return false;
...
{
	$arr=array();
	$strPerm = GetUserPermissions("dbo.Actions");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="dbo.Actions";
	}
	$strPerm = GetUserPermissions("dbo.Anomalies");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="dbo.Anomalies";
	}
	$strPerm = GetUserPermissions("dbo.Customer Module Assignment");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="dbo.Customer Module Assignment";
	}
	$strPerm = GetUserPermissions("dbo.Customers");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="dbo.Customers";
	}
	$strPerm = GetUserPermissions("dbo.Electricity Rates");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="dbo.Electricity Rates";
	}
	$strPerm = GetUserPermissions("dbo.LU_Anomaly Type");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="dbo.LU_Anomaly Type";
	}
	$strPerm = GetUserPermissions("dbo.LU_Customer Type");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="dbo.LU_Customer Type";
	}
	$strPerm = GetUserPermissions("dbo.LU_Locations");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="dbo.LU_Locations";
	}
	$strPerm = GetUserPermissions("dbo.LU_Module Condition");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="dbo.LU_Module Condition";
	}
	$strPerm = GetUserPermissions("dbo.LU_Module Status");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="dbo.LU_Module Status";
	}
	$strPerm = GetUserPermissions("dbo.LU_Module Type");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="dbo.LU_Module Type";
	}
	$strPerm = GetUserPermissions("dbo.Module");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="dbo.Module";
	}
	$strPerm = GetUserPermissions("dbo.Month Billings");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="dbo.Month Billings";
	}
	$strPerm = GetUserPermissions("dbo.Readings");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="dbo.Readings";
	}
	$strPerm = GetUserPermissions("dbo.User Roles");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="dbo.User Roles";
	}
	$strPerm = GetUserPermissions("dbo.System Users");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="dbo.System Users";
	}
	return $arr;
}
...
function GetTableURL($table="")
{
	...
	if(!$table)
		$table=$strTableName;
	if("dbo.Actions"==$table) 
		return "Actions";
	if("dbo.Anomalies"==$table) 
		return "Anomalies";
	if("dbo.Customer Module Assignment"==$table) 
		return "Customer_Module_Assignment";
	if("dbo.Customers"==$table) 
		return "Customers";
	if("dbo.Electricity Rates"==$table) 
		return "Electricity_Rates";
	if("dbo.LU_Anomaly Type"==$table) 
		return "LU_Anomaly_Type";
	if("dbo.LU_Customer Type"==$table) 
		return "LU_Customer_Type";
	if("dbo.LU_Locations"==$table) 
		return "LU_Locations";
	if("dbo.LU_Module Condition"==$table) 
		return "LU_Module_Condition";
	if("dbo.LU_Module Status"==$table) 
		return "LU_Module_Status";
	if("dbo.LU_Module Type"==$table) 
		return "LU_Module_Type";
	if("dbo.Module"==$table) 
		return "Module";
	if("dbo.Month Billings"==$table) 
		return "Month_Billings";
	if("dbo.Readings"==$table) 
		return "Readings";
	if("dbo.User Roles"==$table) 
		return "User_Roles";
	if("dbo.System Users"==$table) 
		return "System_Users";
}
...
{	
	if(!$shortTName)
		return false;
	if("Actions"==$shortTName) 
		return "dbo.Actions";
	if("Anomalies"==$shortTName) 
		return "dbo.Anomalies";
	if("Customer_Module_Assignment"==$shortTName) 
		return "dbo.Customer Module Assignment";
	if("Customers"==$shortTName) 
		return "dbo.Customers";
	if("Electricity_Rates"==$shortTName) 
		return "dbo.Electricity Rates";
	if("LU_Anomaly_Type"==$shortTName) 
		return "dbo.LU_Anomaly Type";
	if("LU_Customer_Type"==$shortTName) 
		return "dbo.LU_Customer Type";
	if("LU_Locations"==$shortTName) 
		return "dbo.LU_Locations";
	if("LU_Module_Condition"==$shortTName) 
		return "dbo.LU_Module Condition";
	if("LU_Module_Status"==$shortTName) 
		return "dbo.LU_Module Status";
	if("LU_Module_Type"==$shortTName) 
		return "dbo.LU_Module Type";
	if("Module"==$shortTName) 
		return "dbo.Module";
	if("Month_Billings"==$shortTName) 
		return "dbo.Month Billings";
	if("Readings"==$shortTName) 
		return "dbo.Readings";
	if("User_Roles"==$shortTName) 
		return "dbo.User Roles";
	if("System_Users"==$shortTName) 
		return "dbo.System Users";
}
...
function ProcessLargeText($strValue, $iquery="",$table="", $mode=MODE_LIST, $format = "")
{
	...
	if($format!=EDIT_FORMAT_LOOKUP_WIZARD && $cNumberOfChars>0 && strlen($strValue)>$cNumberOfChars && $mode==MODE_LIST)
	{
		...
		$ret.=' <a href="javascript:void(0);" query="fulltext.php?table='.$table.'&'.$iquery.'">'.mlang_message("MORE").' ...</a>';
	}
...
function gSQLWhere_having($sqlHead,$sqlFrom,$sqlWhere,$sqlGroupBy,$sqlHaving,$where="", $having="")
{
	...
	$sqlH="";
	if(strlen($sqlHaving))
		$strH=" having ".$sqlHaving." ";		
		
	$sql1="";
	$sql2="";
	$union="";
	
	if(strlen($where) or !strlen($having))
...
function GetUserPermissionsStatic($table="")
{
	...
	if($table=="dbo.Actions" && $sUserGroup=="<Guest>")
	{
				return "S";
	}
//	default permissions	
	if($table=="dbo.Actions")
	{
		return "ADESPI";	// grant all by default
	}
	if($table=="dbo.Anomalies" && $sUserGroup=="<Guest>")
	{
				return "S";
	}
//	default permissions	
	if($table=="dbo.Anomalies")
	{
		return "ADESPI";	// grant all by default
	}
	if($table=="dbo.Customer Module Assignment" && $sUserGroup=="<Guest>")
	{
				return "S";
	}
//	default permissions	
	if($table=="dbo.Customer Module Assignment")
	{
		return "ADESPI";	// grant all by default
	}
	if($table=="dbo.Customers" && $sUserGroup=="<Guest>")
	{
				return "S";
	}
//	default permissions	
	...
	if($table=="dbo.Electricity Rates" && $sUserGroup=="<Guest>")
	{
				return "S";
	}
//	default permissions	
	if($table=="dbo.Electricity Rates")
	{
		return "ADESPI";	// grant all by default
	}
	if($table=="dbo.LU_Anomaly Type" && $sUserGroup=="<Guest>")
	{
				return "S";
	}
//	default permissions	
	if($table=="dbo.LU_Anomaly Type")
	{
		return "ADESPI";	// grant all by default
	}
	if($table=="dbo.LU_Customer Type" && $sUserGroup=="<Guest>")
	{
				return "S";
	}
//	default permissions	
	if($table=="dbo.LU_Customer Type")
	{
		return "ADESPI";	// grant all by default
	}
	if($table=="dbo.LU_Locations" && $sUserGroup=="<Guest>")
	{
				return "S";
	}
//	default permissions	
	if($table=="dbo.LU_Locations")
	{
		return "ADESPI";	// grant all by default
	}
	if($table=="dbo.LU_Module Condition" && $sUserGroup=="<Guest>")
	{
				return "S";
	}
//	default permissions	
	if($table=="dbo.LU_Module Condition")
	{
		return "ADESPI";	// grant all by default
	}
	if($table=="dbo.LU_Module Status" && $sUserGroup=="<Guest>")
	{
				return "S";
	}
//	default permissions	
	if($table=="dbo.LU_Module Status")
	{
		return "ADESPI";	// grant all by default
	}
	if($table=="dbo.LU_Module Type" && $sUserGroup=="<Guest>")
	{
				return "S";
	}
//	default permissions	
	if($table=="dbo.LU_Module Type")
	{
		return "ADESPI";	// grant all by default
	}
	if($table=="dbo.Module" && $sUserGroup=="<Guest>")
	{
				return "S";
	}
//	default permissions	
	...
	if($table=="dbo.Month Billings" && $sUserGroup=="<Guest>")
	{
				return "S";
	}
//	default permissions	
	if($table=="dbo.Month Billings")
	{
		return "ADESPI";	// grant all by default
	}
	if($table=="dbo.Readings" && $sUserGroup=="<Guest>")
	{
				return "S";
	}
//	default permissions	
	if($table=="dbo.Readings")
	{
		return "ADESPI";	// grant all by default
	}
	if($table=="dbo.User Roles" && $sUserGroup=="<Guest>")
	{
				return "S";
	}
//	default permissions	
	if($table=="dbo.User Roles")
	{
		return "ADESPI";	// grant all by default
	}
	if($table=="dbo.System Users" && $sUserGroup=="<Guest>")
	{
				return "";
	}
//	default permissions	
	if($table=="dbo.System Users")
	{
		return "ADESPI";	// grant all by default
	}
}
...
function & GetPageLayout($tableName, $pageType, $sectionName = '')
{
	...
	return $page_layouts[$layoutName];
}
