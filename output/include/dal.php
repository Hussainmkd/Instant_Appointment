...
class tDAL
{
	var $Actions;
	var $Anomalies;
	var $Customer_Module_Assignment;
	var $Customers;
	var $Electricity_Rates;
	var $LU_Anomaly_Type;
	var $LU_Customer_Type;
	var $LU_Locations;
	var $LU_Module_Condition;
	var $LU_Module_Status;
	var $LU_Module_Type;
	var $Module;
	var $Month_Billings;
	var $Readings;
	...
	function FillTablesList()
	{
		if($this->lstTables)
			return;
	  $this->lstTables[]=array("name"=>"dbo.Actions","varname"=>"Actions");
	  $this->lstTables[]=array("name"=>"dbo.Anomalies","varname"=>"Anomalies");
	  $this->lstTables[]=array("name"=>"dbo.Customer Module Assignment","varname"=>"Customer_Module_Assignment");
	  $this->lstTables[]=array("name"=>"dbo.Customers","varname"=>"Customers");
	  $this->lstTables[]=array("name"=>"dbo.Electricity Rates","varname"=>"Electricity_Rates");
	  $this->lstTables[]=array("name"=>"dbo.LU_Anomaly Type","varname"=>"LU_Anomaly_Type");
	  $this->lstTables[]=array("name"=>"dbo.LU_Customer Type","varname"=>"LU_Customer_Type");
	  $this->lstTables[]=array("name"=>"dbo.LU_Locations","varname"=>"LU_Locations");
	  $this->lstTables[]=array("name"=>"dbo.LU_Module Condition","varname"=>"LU_Module_Condition");
	  $this->lstTables[]=array("name"=>"dbo.LU_Module Status","varname"=>"LU_Module_Status");
	  $this->lstTables[]=array("name"=>"dbo.LU_Module Type","varname"=>"LU_Module_Type");
	  $this->lstTables[]=array("name"=>"dbo.Module","varname"=>"Module");
	  $this->lstTables[]=array("name"=>"dbo.Month Billings","varname"=>"Month_Billings");
	  $this->lstTables[]=array("name"=>"dbo.Readings","varname"=>"Readings");
	  $this->lstTables[]=array("name"=>"dbo.sysdiagrams","varname"=>"sysdiagrams");
	  $this->lstTables[]=array("name"=>"dbo.User Roles","varname"=>"User_Roles");
	  $this->lstTables[]=array("name"=>"dbo.System Users","varname"=>"System_Users");
	}
