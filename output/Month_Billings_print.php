...
$layout->blocks["top"][] = "pdf";$page_layouts["Month_Billings_print"] = $layout;
...
$arr = array();
$arr['fName'] = "Bill ID";
$arr['viewFormat'] = ViewFormat("Bill ID", $strTableName);
$fieldsArr[] = $arr;
$arr = array();
$arr['fName'] = "Customer ID";
$arr['viewFormat'] = ViewFormat("Customer ID", $strTableName);
$fieldsArr[] = $arr;
$arr = array();
$arr['fName'] = "Bill Month";
$arr['viewFormat'] = ViewFormat("Bill Month", $strTableName);
$fieldsArr[] = $arr;
$arr = array();
$arr['fName'] = "Previous Readings";
$arr['viewFormat'] = ViewFormat("Previous Readings", $strTableName);
$fieldsArr[] = $arr;
$arr = array();
...
$fieldsArr[] = $arr;
$arr = array();
$arr['fName'] = "Unit Consumed";
$arr['viewFormat'] = ViewFormat("Unit Consumed", $strTableName);
$fieldsArr[] = $arr;
$arr = array();
$arr['fName'] = "Bill Amount";
$arr['viewFormat'] = ViewFormat("Bill Amount", $strTableName);
$fieldsArr[] = $arr;
$arr = array();
$arr['fName'] = "Due Date";
$arr['viewFormat'] = ViewFormat("Due Date", $strTableName);
$fieldsArr[] = $arr;
...
//	Bill ID - 
			$value="";
				$value = ProcessLargeText(GetData($data,"Bill ID", ""),"field=Bill+ID".$keylink,"",MODE_PRINT);
			$record["Bill_ID_value"]=$value;

//	Customer ID - 
			$value="";
				$value = ProcessLargeText(GetData($data,"Customer ID", ""),"field=Customer+ID".$keylink,"",MODE_PRINT);
			$record["Customer_ID_value"]=$value;

//	Bill Month - 
			$value="";
				$value = ProcessLargeText(GetData($data,"Bill Month", ""),"field=Bill+Month".$keylink,"",MODE_PRINT);
			$record["Bill_Month_value"]=$value;

//	Previous Readings - 
			$value="";
				$value = ProcessLargeText(GetData($data,"Previous Readings", ""),"field=Previous+Readings".$keylink,"",MODE_PRINT);
...
$xt->assign("Bill_ID_fieldheadercolumn",true);
$xt->assign("Bill_ID_fieldheader",true);
$xt->assign("Bill_ID_fieldcolumn",true);
$xt->assign("Bill_ID_fieldfootercolumn",true);
...
$xt->assign("Bill_Month_fieldheadercolumn",true);
$xt->assign("Bill_Month_fieldheader",true);
$xt->assign("Bill_Month_fieldcolumn",true);
$xt->assign("Bill_Month_fieldfootercolumn",true);
$xt->assign("Previous_Readings_fieldheadercolumn",true);
$xt->assign("Previous_Readings_fieldheader",true);
$xt->assign("Previous_Readings_fieldcolumn",true);
$xt->assign("Previous_Readings_fieldfootercolumn",true);
...
$xt->assign("Unit_Consumed_fieldheadercolumn",true);
$xt->assign("Unit_Consumed_fieldheader",true);
$xt->assign("Unit_Consumed_fieldcolumn",true);
$xt->assign("Unit_Consumed_fieldfootercolumn",true);
$xt->assign("Bill_Amount_fieldheadercolumn",true);
$xt->assign("Bill_Amount_fieldheader",true);
$xt->assign("Bill_Amount_fieldcolumn",true);
$xt->assign("Bill_Amount_fieldfootercolumn",true);
$xt->assign("Due_Date_fieldheadercolumn",true);
$xt->assign("Due_Date_fieldheader",true);
$xt->assign("Due_Date_fieldcolumn",true);
$xt->assign("Due_Date_fieldfootercolumn",true);
...
$templatefile = "Month_Billings_print.htm";
