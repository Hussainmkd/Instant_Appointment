...
$layout->blocks["top"][] = "details";$page_layouts["Readings_edit"] = $layout;
...
$templatefile = ($inlineedit == EDIT_INLINE) ? "Readings_inline_edit.htm" : "Readings_edit.htm";
...
$skeys = "";
$savedKeys = array();
$keys["Record ID"]=urldecode(postvalue("editid1"));
$savedKeys["Record ID"]=urldecode(postvalue("editid1"));
	...
	if($condition)
	{
		...
		{	
			...
			if(0 && "Voltage Red"=="Password" && $url_page=="admin_users_")
				$value = md5($value);
			$evalues["Voltage Red"] = $value;
		
			}
	
		}
//	processing Voltage Red - end
//	processing Voltage Blue - begin
	$condition = 1;
	...
	if($condition)
	{
		...
		{	
			...
			if(0 && "Voltage Blue"=="Password" && $url_page=="admin_users_")
				$value = md5($value);
			$evalues["Voltage Blue"] = $value;
		
			}
	
		}
//	processing Voltage Blue - end
//	processing Voltage Yellow - begin
	$condition = 1;
	...
	if($condition)
	{
		...
		{	
			...
			if(0 && "Voltage Yellow"=="Password" && $url_page=="admin_users_")
				$value = md5($value);
			$evalues["Voltage Yellow"] = $value;
		
			}
	
		}
//	processing Voltage Yellow - end
//	processing Currunt Red - begin
	$condition = 1;
	...
	if($condition)
	{
		...
		{	
			...
			if(0 && "Currunt Red"=="Password" && $url_page=="admin_users_")
				$value = md5($value);
			$evalues["Currunt Red"] = $value;
		
			}
	
		}
//	processing Currunt Red - end
//	processing Currunt Blue - begin
	$condition = 1;
	...
	if($condition)
	{
		...
		{	
			...
			if(0 && "Currunt Blue"=="Password" && $url_page=="admin_users_")
				$value = md5($value);
			$evalues["Currunt Blue"] = $value;
		
			}
	
		}
//	processing Currunt Blue - end
//	processing Currunt Yellow - begin
	$condition = 1;
	...
	if($condition)
	{
		...
		{	
			...
			if(0 && "Currunt Yellow"=="Password" && $url_page=="admin_users_")
				$value = md5($value);
			$evalues["Currunt Yellow"] = $value;
		
			}
	
		}
//	processing Currunt Yellow - end
//	processing PF Red - begin
	$condition = 1;
	...
	if($condition)
	{
		...
		{	
			...
			if(0 && "PF Red"=="Password" && $url_page=="admin_users_")
				$value = md5($value);
			$evalues["PF Red"] = $value;
		
			}
	
		}
//	processing PF Red - end
//	processing PF Blue - begin
	$condition = 1;
	...
	if($condition)
	{
		...
		{	
			...
			if(0 && "PF Blue"=="Password" && $url_page=="admin_users_")
				$value = md5($value);
			$evalues["PF Blue"] = $value;
		
			}
	
		}
//	processing PF Blue - end
//	processing PF Yellow - begin
	$condition = 1;
	...
	if($condition)
	{
		...
		{	
			...
			if(0 && "PF Yellow"=="Password" && $url_page=="admin_users_")
				$value = md5($value);
			$evalues["PF Yellow"] = $value;
		
			}
	
		}
//	processing PF Yellow - end
//	processing Peak Power - begin
	$condition = 1;
	...
	if($condition)
	{
		...
		{	
			...
			if(0 && "Peak Power"=="Password" && $url_page=="admin_users_")
				$value = md5($value);
			$evalues["Peak Power"] = $value;
		
			}
	
		}
//	processing Peak Power - end
...
if ($IsSaved && no_output_done() && $inlineedit == EDIT_SIMPLE)
{
	...
	// key get query
	$keyGetQ = "";
		$keyGetQ.="editid1=".rawurldecode($keys["Record ID"])."&";
	// cut last &
	$keyGetQ = substr($keyGetQ, 0, strlen($keyGetQ)-1);	
	// redirect
	header("Location: Readings_".$pageObject->getPageType().".php?".$keyGetQ);
...
if(!$data)
{
	...
	{
		header("Location: Readings_list.php?a=return");
		exit();
	}
	else
		$data = array();
...
if($readevalues)
{
	...
	$data["Voltage Red"] = $evalues["Voltage Red"];
	$data["Voltage Blue"] = $evalues["Voltage Blue"];
	$data["Voltage Yellow"] = $evalues["Voltage Yellow"];
	$data["Currunt Red"] = $evalues["Currunt Red"];
	$data["Currunt Blue"] = $evalues["Currunt Blue"];
	$data["Currunt Yellow"] = $evalues["Currunt Yellow"];
	$data["PF Red"] = $evalues["PF Red"];
	$data["PF Blue"] = $evalues["PF Blue"];
	$data["PF Yellow"] = $evalues["PF Yellow"];
	$data["Peak Power"] = $evalues["Peak Power"];
	$data["Date Time"] = $evalues["Date Time"];
	$data["IsSync"] = $evalues["IsSync"];
...
$xt->assign("viewlink_attrs","id=\"viewButton".$id."\" name=\"viewButton".$id."\" onclick=\"window.location.href='Readings_view.php?".$viewlink."'\"");
