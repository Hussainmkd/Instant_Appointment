...
$layout->blocks["top"][] = "export";$page_layouts["LU_Module_Type_export"] = $layout;
...
$xt->display("LU_Module_Type_export.htm");

function ExportToWord()
{
	global $cCharset;
	header("Content-Type: application/vnd.ms-word");
	header("Content-Disposition: attachment;Filename=LU_Module_Type.doc");
...
function ExportToXML()
{
	...
	header("Content-Disposition: attachment;Filename=LU_Module_Type.xml");
	...
	while((!$nPageSize || $i<$nPageSize) && $row)
	{
		...
		$values = array();
			...
			$values["Module Type"] = GetData($row,"Module Type","");
...
function ExportToCSV()
{
	...
	header("Content-Disposition: attachment;Filename=LU_Module_Type.csv");
...
// write data rows
	...
	while((!$nPageSize || $iNumberOfRows<$nPageSize) && $row)
	{
		...
		$values = array();
			...
			$format="";
			$values["Module Type"] = GetData($row,"Module Type",$format);
...
// write header
	...
	{
		echo '<td style="width: 100" x:str>'.PrepareForExcel(GetFieldLabel("dbo_LU_Module_Type","Code")).'</td>';	
		echo '<td style="width: 100" x:str>'.PrepareForExcel(GetFieldLabel("dbo_LU_Module_Type","Module_Type")).'</td>';	
	}
	else
	{
		echo "<td>".GetFieldLabel("dbo_LU_Module_Type","Code")."</td>";
		echo "<td>".GetFieldLabel("dbo_LU_Module_Type","Module_Type")."</td>";
	}
	echo "</tr>";
		$totals["Code"]=0;
