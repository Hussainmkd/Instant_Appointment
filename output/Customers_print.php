...
$layout->blocks["top"][] = "pdf";$page_layouts["Customers_print"] = $layout;
...
//	Father Name - 
			...
			$record["Father_Name_value"]=$value;
...
//	Customer Type - 
			...
			$record["Customer_Type_value"]=$value;
			if($col<$colsonpage)
...
//	include proper masterprint.php code
	include("include/LU_Customer_Type_masterprint.php");
	$masterkeys[]=@$_SESSION[$strTableName."_masterkey1"];
	$params=array("detailtable"=>"dbo.Customers","keys"=>$masterkeys);
	$master=array();
	$master["func"]="DisplayMasterTableInfo_LU_Customer_Type";
...
{
//	include proper masterprint.php code
	include("include/LU_Locations_masterprint.php");
	$masterkeys[]=@$_SESSION[$strTableName."_masterkey1"];
	$params=array("detailtable"=>"dbo.Customers","keys"=>$masterkeys);
	$master=array();
	$master["func"]="DisplayMasterTableInfo_LU_Locations";
	$master["params"]=$params;
	$xt->assignbyref("showmasterfile",$master);
	$xt->assign("mastertable_block",true);
}
...
$xt->assign("Father_Name_fieldheadercolumn",true);
$xt->assign("Father_Name_fieldheader",true);
$xt->assign("Father_Name_fieldcolumn",true);
$xt->assign("Father_Name_fieldfootercolumn",true);
...
$xt->assign("Contact_fieldheadercolumn",true);
$xt->assign("Contact_fieldheader",true);
$xt->assign("Contact_fieldcolumn",true);
$xt->assign("Contact_fieldfootercolumn",true);
...
$xt->assign("Customer_Type_fieldheadercolumn",true);
$xt->assign("Customer_Type_fieldheader",true);
$xt->assign("Customer_Type_fieldcolumn",true);
$xt->assign("Customer_Type_fieldfootercolumn",true);
...
$templatefile = "Customers_print.htm";
