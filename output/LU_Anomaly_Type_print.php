...
$layout->blocks["top"][] = "pdf";$page_layouts["LU_Anomaly_Type_print"] = $layout;
...
$fieldsArr[] = $arr;
$arr = array();
$arr['fName'] = "Tamper Type";
$arr['viewFormat'] = ViewFormat("Tamper Type", $strTableName);
$fieldsArr[] = $arr;
...
$xt->assign("Tamper_Type_fieldheadercolumn",true);
$xt->assign("Tamper_Type_fieldheader",true);
$xt->assign("Tamper_Type_fieldcolumn",true);
$xt->assign("Tamper_Type_fieldfootercolumn",true);
...
$templatefile = "LU_Anomaly_Type_print.htm";
