...
$layout->blocks["top"][] = "details";$page_layouts["LU_Anomaly_Type_view"] = $layout;
...
$xt->assign("editlink_attrs","id=\"editLink".$id."\" name=\"editLink".$id."\" onclick=\"window.location.href='LU_Anomaly_Type_edit.php?".$editlink."'\"");
...
$templatefile = "LU_Anomaly_Type_view.htm";
