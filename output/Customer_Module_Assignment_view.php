...
$layout->blocks["top"][] = "details";$page_layouts["Customer_Module_Assignment_view"] = $layout;
...
$xt->assign("editlink_attrs","id=\"editLink".$id."\" name=\"editLink".$id."\" onclick=\"window.location.href='Customer_Module_Assignment_edit.php?".$editlink."'\"");
...
$templatefile = "Customer_Module_Assignment_view.htm";
