...
$layout->blocks["top"][] = "details";$page_layouts["Customers_edit"] = $layout;
...
$templatefile = ($inlineedit == EDIT_INLINE) ? "Customers_inline_edit.htm" : "Customers_edit.htm";
...
//	processing Name - end
//	processing Father Name - begin
	$condition = 1;

	if($condition)
	{
		$value = postvalue("value_Father_Name_".$id);
		$type = postvalue("type_Father_Name_".$id);
		if(FieldSubmitted("Father Name_".$id))
		{
				$value = prepare_for_db("Father Name",$value,$type);
		}
		else
			$value = false;
		...
		{	
			...
			if(0 && "Father Name"=="Password" && $url_page=="admin_users_")
				$value = md5($value);
			$evalues["Father Name"] = $value;
		
			}
	
		}
//	processing Father Name - end
...
if ($IsSaved && no_output_done() && $inlineedit == EDIT_SIMPLE)
{
	...
	// redirect
	header("Location: Customers_".$pageObject->getPageType().".php?".$keyGetQ);
...
/////////////////////////////////////////////////////////////
$query = $queryData_Customers->Copy();
...
if(!$data)
{
	...
	{
		header("Location: Customers_list.php?a=return");
		exit();
	}
	else
		$data = array();
...
//	Father Name - 
		...
		$value = "";
			$value = ProcessLargeText(GetData($data,"Father Name", ""),"field=Father+Name".$keylink,"",MODE_LIST);
	$showValues["Father Name"] = $value;
	$showFields[] = "Father Name";
		$showRawValues["Father Name"] = substr($data["Father Name"],0,100);
...
//	Customer Type - 
	...
	$showValues["Customer Type"] = $value;
	$showFields[] = "Customer Type";
		$showRawValues["Customer Type"] = substr($data["Customer Type"],0,100);
/////////////////////////////////////////////////////////////
//	start inline output
/////////////////////////////////////////////////////////////
...
$xt->assign("viewlink_attrs","id=\"viewButton".$id."\" name=\"viewButton".$id."\" onclick=\"window.location.href='Customers_view.php?".$viewlink."'\"");
