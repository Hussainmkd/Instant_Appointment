...
$layout->blocks["top"][] = "search";$page_layouts["Actions_search"] = $layout;
...
$mode=SEARCH_SIMPLE;
$templatefile = "Actions_search.htm";

// for ajax query, used when page buffers new control
if(postvalue("mode")=="inlineLoadCtrl"){
	$mode = SEARCH_LOAD_CONTROL;
	$templatefile = "Actions_inline_search.htm";
}	
...
if ($mode==SEARCH_SIMPLE)
{
	...
	if(GetLookupTable("Action", $strTableName))
		$pageObject->settingsMap["globalSettings"]['shortTNames'][GetLookupTable("Action", $strTableName)] = GetTableURL(GetLookupTable("Action", $strTableName));
