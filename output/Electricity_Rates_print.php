...
$layout->blocks["top"][] = "pdf";$page_layouts["Electricity_Rates_print"] = $layout;
...
$arr = array();
$arr['fName'] = "Units";
$arr['viewFormat'] = ViewFormat("Units", $strTableName);
$fieldsArr[] = $arr;
$arr = array();
$arr['fName'] = "PerUnit Price";
$arr['viewFormat'] = ViewFormat("PerUnit Price", $strTableName);
$fieldsArr[] = $arr;
...
$xt->assign("Units_fieldheadercolumn",true);
$xt->assign("Units_fieldheader",true);
$xt->assign("Units_fieldcolumn",true);
$xt->assign("Units_fieldfootercolumn",true);
$xt->assign("PerUnit_Price_fieldheadercolumn",true);
$xt->assign("PerUnit_Price_fieldheader",true);
$xt->assign("PerUnit_Price_fieldcolumn",true);
$xt->assign("PerUnit_Price_fieldfootercolumn",true);
...
$templatefile = "Electricity_Rates_print.htm";
