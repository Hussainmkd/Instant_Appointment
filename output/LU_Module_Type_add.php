...
$layout->blocks["top"][] = "details";$page_layouts["LU_Module_Type_add"] = $layout;
...
if($inlineadd == ADD_INLINE)
	$templatefile = "LU_Module_Type_inline_add.htm";
else
	$templatefile = "LU_Module_Type_add.htm";
			...
			if($inlineadd==ADD_SIMPLE || $inlineadd==ADD_MASTER)
			{
				...
				if (count($keys))
				{
					...
					if(GetTableData($strTableName,".edit",false) && $permis['edit'])
						$message .='&nbsp;<a href=\'LU_Module_Type_edit.php?'.$keylink.'\'>'.mlang_message("EDIT").'</a>&nbsp;';
					if(GetTableData($strTableName,".view",false) && $permis['search'])
						$message .='&nbsp;<a href=\'LU_Module_Type_view.php?'.$keylink.'\'>'.mlang_message("VIEW").'</a>&nbsp;';
				}
				$mesClass = "mes_ok";	
			}
		}
...
if (no_output_done() && $inlineadd==ADD_SIMPLE && $IsSaved)
{
	...
	// redirect
	header("Location: LU_Module_Type_".$pageObject->getPageType().".php");
