...
$layout->blocks["top"][] = "search";$page_layouts["LU_Module_Status_search"] = $layout;
...
$mode=SEARCH_SIMPLE;
$templatefile = "LU_Module_Status_search.htm";

// for ajax query, used when page buffers new control
if(postvalue("mode")=="inlineLoadCtrl"){
	$mode = SEARCH_LOAD_CONTROL;
	$templatefile = "LU_Module_Status_inline_search.htm";
}	
...
$params['xt'] = &$xt;
$params['shortTableName'] = 'LU_Module_Status';
