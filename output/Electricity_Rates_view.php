...
$layout->blocks["top"][] = "details";$page_layouts["Electricity_Rates_view"] = $layout;
...
$xt->assign("editlink_attrs","id=\"editLink".$id."\" name=\"editLink".$id."\" onclick=\"window.location.href='Electricity_Rates_edit.php?".$editlink."'\"");
...
$templatefile = "Electricity_Rates_view.htm";
