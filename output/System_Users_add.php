...
$layout->blocks["top"][] = "details";$page_layouts["System_Users_add"] = $layout;
...
if($inlineadd == ADD_INLINE)
	$templatefile = "System_Users_inline_add.htm";
else
	$templatefile = "System_Users_add.htm";
...
if (no_output_done() && $inlineadd==ADD_SIMPLE && $IsSaved)
{
	...
	// redirect
	header("Location: System_Users_".$pageObject->getPageType().".php");
...
if(@$_SESSION[$sessionPrefix."_mastertable"]=="dbo.User Roles")
{
	...
	if(postvalue("mainMPageType")<>"add")
		$defvalues["Role"] = @$_SESSION[$sessionPrefix."_masterkey1"];	
...
if($readavalues)
{
	...
	$defvalues["User Name"]=@$avalues["User Name"];
