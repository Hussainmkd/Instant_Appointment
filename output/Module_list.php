...
include("include/Anomalies_settings.php");
include("include/Customer_Module_Assignment_settings.php");
include("include/Readings_settings.php");
...
$layout->blocks["top"][] = "search";$page_layouts["Module_list"] = $layout;
