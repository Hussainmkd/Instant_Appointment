...
$layout->blocks["top"][] = "details";$page_layouts["LU_Module_Status_edit"] = $layout;
...
$templatefile = ($inlineedit == EDIT_INLINE) ? "LU_Module_Status_inline_edit.htm" : "LU_Module_Status_edit.htm";
...
if ($IsSaved && no_output_done() && $inlineedit == EDIT_SIMPLE)
{
	...
	// redirect
	header("Location: LU_Module_Status_".$pageObject->getPageType().".php?".$keyGetQ);
...
/////////////////////////////////////////////////////////////
$query = $queryData_LU_Module_Status->Copy();
...
if(!$data)
{
	...
	{
		header("Location: LU_Module_Status_list.php?a=return");
		exit();
	}
	else
		$data = array();
...
$xt->assign("viewlink_attrs","id=\"viewButton".$id."\" name=\"viewButton".$id."\" onclick=\"window.location.href='LU_Module_Status_view.php?".$viewlink."'\"");
