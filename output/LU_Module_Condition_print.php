...
$layout->blocks["top"][] = "pdf";$page_layouts["LU_Module_Condition_print"] = $layout;
...
$arr = array();
$arr['fName'] = "Code";
$arr['viewFormat'] = ViewFormat("Code", $strTableName);
$fieldsArr[] = $arr;
$arr = array();
$arr['fName'] = "Condition";
$arr['viewFormat'] = ViewFormat("Condition", $strTableName);
$fieldsArr[] = $arr;
...
//	Condition - 
			$value="";
				$value = ProcessLargeText(GetData($data,"Condition", ""),"field=Condition".$keylink,"",MODE_PRINT);
...
$xt->assign("Code_fieldheadercolumn",true);
$xt->assign("Code_fieldheader",true);
$xt->assign("Code_fieldcolumn",true);
$xt->assign("Code_fieldfootercolumn",true);
$xt->assign("Condition_fieldheadercolumn",true);
$xt->assign("Condition_fieldheader",true);
$xt->assign("Condition_fieldcolumn",true);
$xt->assign("Condition_fieldfootercolumn",true);
...
$templatefile = "LU_Module_Condition_print.htm";
