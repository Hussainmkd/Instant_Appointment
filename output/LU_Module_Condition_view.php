...
$layout->blocks["top"][] = "details";$page_layouts["LU_Module_Condition_view"] = $layout;
...
$xt->assign("editlink_attrs","id=\"editLink".$id."\" name=\"editLink".$id."\" onclick=\"window.location.href='LU_Module_Condition_edit.php?".$editlink."'\"");
...
$templatefile = "LU_Module_Condition_view.htm";
