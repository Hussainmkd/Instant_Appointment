...
$layout->blocks["top"][] = "search";$page_layouts["LU_Customer_Type_search"] = $layout;
...
$mode=SEARCH_SIMPLE;
$templatefile = "LU_Customer_Type_search.htm";

// for ajax query, used when page buffers new control
if(postvalue("mode")=="inlineLoadCtrl"){
	$mode = SEARCH_LOAD_CONTROL;
	$templatefile = "LU_Customer_Type_inline_search.htm";
}	
...
$params['xt'] = &$xt;
$params['shortTableName'] = 'LU_Customer_Type';
...
if ($mode==SEARCH_SIMPLE)
{
	...
	if(GetLookupTable("Type", $strTableName))
		$pageObject->settingsMap["globalSettings"]['shortTNames'][GetLookupTable("Type", $strTableName)] = GetTableURL(GetLookupTable("Type", $strTableName));
