...
$layout->blocks["top"][] = "export";$page_layouts["LU_Locations_export"] = $layout;
...
$xt->display("LU_Locations_export.htm");

function ExportToWord()
{
	global $cCharset;
	header("Content-Type: application/vnd.ms-word");
	header("Content-Disposition: attachment;Filename=LU_Locations.doc");
...
function ExportToXML()
{
	...
	header("Content-Disposition: attachment;Filename=LU_Locations.xml");
	...
	while((!$nPageSize || $i<$nPageSize) && $row)
	{
		...
		$values = array();
			...
			$values["Location"] = GetData($row,"Location","");
...
function ExportToCSV()
{
	...
	header("Content-Disposition: attachment;Filename=LU_Locations.csv");
...
// write data rows
	...
	while((!$nPageSize || $iNumberOfRows<$nPageSize) && $row)
	{
		...
		$values = array();
			...
			$format="";
			$values["Location"] = GetData($row,"Location",$format);
...
// write header
	...
	{
		echo '<td style="width: 100" x:str>'.PrepareForExcel(GetFieldLabel("dbo_LU_Locations","Code")).'</td>';	
		echo '<td style="width: 100" x:str>'.PrepareForExcel(GetFieldLabel("dbo_LU_Locations","Location")).'</td>';	
	}
	else
	{
		echo "<td>".GetFieldLabel("dbo_LU_Locations","Code")."</td>";
		echo "<td>".GetFieldLabel("dbo_LU_Locations","Location")."</td>";
	}
	echo "</tr>";
		$totals["Code"]=0;
