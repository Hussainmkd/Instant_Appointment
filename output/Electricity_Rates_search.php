...
$layout->blocks["top"][] = "search";$page_layouts["Electricity_Rates_search"] = $layout;
...
$mode=SEARCH_SIMPLE;
$templatefile = "Electricity_Rates_search.htm";

// for ajax query, used when page buffers new control
if(postvalue("mode")=="inlineLoadCtrl"){
	$mode = SEARCH_LOAD_CONTROL;
	$templatefile = "Electricity_Rates_inline_search.htm";
}	
...
if ($mode==SEARCH_SIMPLE)
{
	...
	if(isEnableSection508())
		$xt->assign_section("Units_label","<label for=\"".GetInputElementId("Units", $id)."\">","</label>");
	else 
		$xt->assign("Units_label", true);
	
	$xt->assign("Units_fieldblock", true);		
	$xt->assignbyref("Units_editcontrol", $ctrlBlockArr['searchcontrol']);					
	$xt->assign("Units_notbox", $ctrlBlockArr['notbox']);		
	...
	{	
		$pageObject->controlsMap["search"]["searchBlocks"][] = array('fName'=>"PerUnit Price", 'recId'=>$id, 'ctrlsMap'=>array(0=>$ctrlInd));			
		$ctrlInd++;
	}
