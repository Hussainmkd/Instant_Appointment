...
$layout->blocks["top"][] = "details";$page_layouts["LU_Locations_view"] = $layout;
...
$xt->assign("editlink_attrs","id=\"editLink".$id."\" name=\"editLink".$id."\" onclick=\"window.location.href='LU_Locations_edit.php?".$editlink."'\"");
...
$templatefile = "LU_Locations_view.htm";
