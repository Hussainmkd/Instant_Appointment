...
$layout->blocks["top"][] = "details";$page_layouts["Actions_view"] = $layout;
...
$arr = array();
$arr['fName'] = "Action";
$arr['viewFormat'] = ViewFormat("Action", $strTableName);
$fieldsArr[] = $arr;
...
$xt->assign("editlink_attrs","id=\"editLink".$id."\" name=\"editLink".$id."\" onclick=\"window.location.href='Actions_edit.php?".$editlink."'\"");
