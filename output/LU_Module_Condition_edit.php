...
$layout->blocks["top"][] = "details";$page_layouts["LU_Module_Condition_edit"] = $layout;
...
$templatefile = ($inlineedit == EDIT_INLINE) ? "LU_Module_Condition_inline_edit.htm" : "LU_Module_Condition_edit.htm";
...
if ($IsSaved && no_output_done() && $inlineedit == EDIT_SIMPLE)
{
	...
	// redirect
	header("Location: LU_Module_Condition_".$pageObject->getPageType().".php?".$keyGetQ);
...
/////////////////////////////////////////////////////////////
$query = $queryData_LU_Module_Condition->Copy();
...
if(!$data)
{
	...
	{
		header("Location: LU_Module_Condition_list.php?a=return");
		exit();
	}
	else
		$data = array();
...
if($readevalues)
{
	$data["Condition"] = $evalues["Condition"];
}
...
//	detail tables
	$showDetailKeys["dbo.Module"]["masterkey1"] = $data["Code"];		
...
//	Condition - 
		...
		$value = "";
			$value = ProcessLargeText(GetData($data,"Condition", ""),"field=Condition".$keylink,"",MODE_LIST);
	$showValues["Condition"] = $value;
	$showFields[] = "Condition";
		$showRawValues["Condition"] = substr($data["Condition"],0,100);
/////////////////////////////////////////////////////////////
//	start inline output
/////////////////////////////////////////////////////////////
...
if($pageObject->isShowDetailTables && $inlineedit!=EDIT_INLINE && !isMobile())
{
	...
	for($d=0;$d<count($dpParams['ids']);$d++)
	{
		...
		$options['masterTable'] = "dbo.LU_Module Condition";
		$options['firstTime'] = 1;
...
$xt->assign("viewlink_attrs","id=\"viewButton".$id."\" name=\"viewButton".$id."\" onclick=\"window.location.href='LU_Module_Condition_view.php?".$viewlink."'\"");
