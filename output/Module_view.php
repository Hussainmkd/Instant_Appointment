...
$layout->blocks["top"][] = "details";$page_layouts["Module_view"] = $layout;
...
//Module Type - 
	...
	$value="";
	$value=DisplayLookupWizard("Module Type",$data["Module Type"],$data,$keylink,MODE_VIEW);
...
//Module Status - 
	...
	$value="";
	$value=DisplayLookupWizard("Module Status",$data["Module Status"],$data,$keylink,MODE_VIEW);
	if($mainTableOwnerID=="Module Status")
		$ownerIdValue=$value;
	$xt->assign("Module_Status_value",$value);
...
//Module Condition - 
	...
	$value="";
	$value=DisplayLookupWizard("Module Condition",$data["Module Condition"],$data,$keylink,MODE_VIEW);
	if($mainTableOwnerID=="Module Condition")
		$ownerIdValue=$value;
	$xt->assign("Module_Condition_value",$value);
...
//Serial Num - 
	...
	$value="";
	$value = ProcessLargeText(GetData($data,"Serial Num", ""),"","",MODE_VIEW);
	if($mainTableOwnerID=="Serial Num")
		$ownerIdValue=$value;
	$xt->assign("Serial_Num_value",$value);
...
//Entry Date - Short Date
	...
	$value="";
	$value = ProcessLargeText(GetData($data,"Entry Date", "Short Date"),"","",MODE_VIEW);
	if($mainTableOwnerID=="Entry Date")
		$ownerIdValue=$value;
	$xt->assign("Entry_Date_value",$value);
...
$xt->assign("editlink_attrs","id=\"editLink".$id."\" name=\"editLink".$id."\" onclick=\"window.location.href='Module_edit.php?".$editlink."'\"");
