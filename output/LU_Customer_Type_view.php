...
$layout->blocks["top"][] = "details";$page_layouts["LU_Customer_Type_view"] = $layout;
...
$arr = array();
$arr['fName'] = "Type";
$arr['viewFormat'] = ViewFormat("Type", $strTableName);
$fieldsArr[] = $arr;
...
$xt->assign("editlink_attrs","id=\"editLink".$id."\" name=\"editLink".$id."\" onclick=\"window.location.href='LU_Customer_Type_edit.php?".$editlink."'\"");
...
$templatefile = "LU_Customer_Type_view.htm";
