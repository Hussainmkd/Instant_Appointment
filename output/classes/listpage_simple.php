...
class ListPage_Simple extends ListPage 
{
	...
	function commonAssign() 
	{
		...
		$this->xt->assign("record_controls", ($this->permis[$this->tName]['export'] || $this->permis[$this->tName]['add'] || $this->permis[$this->tName]['delete'] || $this->permis[$this->tName]['edit']));
		...
		$this->xt->assign('menu_block', $this->isShowMenu());
