...
$layout->blocks["top"][] = "export";$page_layouts["LU_Customer_Type_export"] = $layout;
...
$xt->display("LU_Customer_Type_export.htm");

function ExportToWord()
{
	global $cCharset;
	header("Content-Type: application/vnd.ms-word");
	header("Content-Disposition: attachment;Filename=LU_Customer_Type.doc");
...
function ExportToXML()
{
	...
	header("Content-Disposition: attachment;Filename=LU_Customer_Type.xml");
...
function ExportToCSV()
{
	...
	header("Content-Disposition: attachment;Filename=LU_Customer_Type.csv");
...
// write header
	...
	{
		echo '<td style="width: 100" x:str>'.PrepareForExcel(GetFieldLabel("dbo_LU_Customer_Type","Code")).'</td>';	
		echo '<td style="width: 100" x:str>'.PrepareForExcel(GetFieldLabel("dbo_LU_Customer_Type","Type")).'</td>';	
	}
	else
	{
		echo "<td>".GetFieldLabel("dbo_LU_Customer_Type","Code")."</td>";
		echo "<td>".GetFieldLabel("dbo_LU_Customer_Type","Type")."</td>";
	}
	echo "</tr>";
		$totals["Code"]=0;
		$totalsFields[]=array('fName'=>"Code", 'totalsType'=>'', 'viewFormat'=>"");
		$totals["Type"]=0;
		$totalsFields[]=array('fName'=>"Type", 'totalsType'=>'', 'viewFormat'=>"");
	$totals=array();
// write data rows
	$iNumberOfRows = 0;
	while((!$nPageSize || $iNumberOfRows<$nPageSize) && $row)
